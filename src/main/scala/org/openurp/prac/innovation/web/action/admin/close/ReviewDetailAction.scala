...
import org.openurp.prac.innovation.model.{Batch, ClosureReview, ClosureReviewDetail, ProjectCategory}

class ReviewDetailAction extends RestfulAction[ClosureReviewDetail], ExportSupport[ClosureReviewDetail] {
  ...
  def clear(): View = {
    val details = entityDao.find(classOf[ClosureReviewDetail], getLongIds("detail"))
