...
[@b.grid items=projects var="project"]
  ...
  [@b.row]
    ...
    [/@]
    [@b.col width="7%" property="manager.std.name" title="负责人"]
    ...
    [#list project.levels as l]
       [#assign existed = (yearLevels[l.awardYear?string])![] /]
       [#assign yearLevels= yearLevels + {l.awardYear?string:(existed+[l.level])}/]
    [/#list]
