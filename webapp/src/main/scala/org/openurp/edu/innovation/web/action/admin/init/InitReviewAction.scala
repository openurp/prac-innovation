 ...
 */
package org.openurp.edu.innovation.web.action.admin.init
...
import org.openurp.edu.innovation.model.{InitReviewGroup, _}
...
class InitReviewAction extends RestfulAction[InitReview] {
  ...
  override def search(): View = {
    ...
    stat.where("ir.project.batch.id=:batchId", intId("review.project.batch"))
  ...
  def assign(): View = {
    val reviews = entityDao.find(classOf[InitReview], longIds("review"))
    val group = entityDao.get(classOf[InitReviewGroup], longId("reviewGroup"))
