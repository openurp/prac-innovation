...
<table class="infoTable">
  ...
  <tr>
    ...
    <td class="content">${(detail.review.project.manager.std.user.code)!} ${(detail.review.project.manager.std.user.name)!}</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td class="content">${(detail.level.name)!}</td>
  </tr>
  <tr>
