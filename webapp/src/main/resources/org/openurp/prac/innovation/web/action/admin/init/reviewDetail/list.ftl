...
[@b.grid items=details var="detail"]
  [@b.gridbar]
    ...
    bar.addItem("${b.text("action.export")}",action.exportData("review.project.code:编号,review.project.title:项目名称,review.project.manager.std.user.name:负责人,review.project.department.name:院系,expert.code:评审专家,score:分数,passed:是否推荐立项,comments:评审意见,review.group.name:评审小组",null,'fileName=专家立项评审信息'));
  [/@]
  [@b.row]
    [@b.boxcol /]
